...
export default function ApplyJobPage() {
  ...
  const [jobId, setJobId] = useState(""); // Add state for job ID
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // You need to set the jobId from somewhere - perhaps from localStorage or context
    if (!jobId) {
    ...
    try {
      ...
      await api.post(
        "/job/application",
        {
          job_id: jobId, // Include job ID in the request
...
//   You'll need to set the jobId when navigating to this page
//   For example, in your jobs page when clicking apply:
//   localStorage.setItem('currentJobId', job.id);
//   router.push('/apply-job');
//   Then here in useEffect:
  useEffect(() => {
