...
import { FiHome, FiBriefcase, FiInfo, FiMail, FiUser, FiLogOut } from "react-icons/fi";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {user && (
              <NavLink href="/user-dashboard" icon={<RiDashboardLine className="mr-1" />}>
                Dashboard
              </NavLink>
            )}

            {user?.role === "admin" && (
              <NavLink href="/admin-dashboard" icon={<RiAdminLine className="mr-1" />}>
                Admin
              </NavLink>
            )}
          </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {user && (
              <MobileNavLink href="/user-dashboard" icon={<RiDashboardLine className="mr-2" />}>
                Dashboard
              </MobileNavLink>
            )}

            {user?.role === "admin" && (
              <MobileNavLink href="/admin-dashboard" icon={<RiAdminLine className="mr-2" />}>
                Admin
              </MobileNavLink>
            )}
