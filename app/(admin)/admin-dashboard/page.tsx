...
/>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        {[
          ...
          <div
            key={i}
            className={`${stat.bg} ${stat.text} p-4 rounded-lg shadow-sm`}
          >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-6">
          <div className="text-sm text-gray-600">
            ...
            <span className="font-medium">
              {(state.currentPage - 1) * 10 + 1}
            </span>{" "}
            to{" "}
            <span className="font-medium">
              {Math.min(state.currentPage * 10, state.totalJobs)}
            </span>{" "}
            of <span className="font-medium">{state.totalJobs}</span> jobs
          </div>
